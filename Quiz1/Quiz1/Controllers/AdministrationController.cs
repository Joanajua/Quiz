    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> DeleteUser(string id)
        {
            ...
            catch (DbUpdateException ex)
            {
                ...
                ViewBag.ErrorMessage =
                    $"{user.UserName} user cannot be deleted as might be assigned to a admin role. " +
                    "If you want to delete this user, please un-assign the role from it and follow to delete it.";
                return View("Error");
            }
        }
