...
namespace Quiz1.Utilities.CustomExtensions
{
    ...
    public static class ModelBuilderExtensions
    {
        ...
        private static Answer[] _mockAnswers = new[]
        {
            ...
            new Answer {AnswerId = 8,  QuestionId = 2, AnswerText = "Answer 4", IsCorrect = false},

            new Answer {AnswerId = 9,  QuestionId = 3, AnswerText = "Answer 1", IsCorrect = false},
            new Answer {AnswerId = 10,  QuestionId = 3, AnswerText = "Answer 2", IsCorrect = false},
            new Answer {AnswerId = 11,  QuestionId = 3, AnswerText = "Answer 3", IsCorrect = true},
            new Answer {AnswerId = 12,  QuestionId = 3, AnswerText = "Answer 4", IsCorrect = false},

            new Answer {AnswerId = 13,  QuestionId = 4, AnswerText = "Answer 1", IsCorrect = false},
            new Answer {AnswerId = 14,  QuestionId = 4, AnswerText = "Answer 2", IsCorrect = false},
            new Answer {AnswerId = 15,  QuestionId = 4, AnswerText = "Answer 3", IsCorrect = true},
            new Answer {AnswerId = 16,  QuestionId = 4, AnswerText = "Answer 4", IsCorrect = false},

            new Answer {AnswerId = 17,  QuestionId = 5, AnswerText = "Answer 1", IsCorrect = false},
            new Answer {AnswerId = 18,  QuestionId = 5, AnswerText = "Answer 2", IsCorrect = false},
            new Answer {AnswerId = 19,  QuestionId = 5, AnswerText = "Answer 3", IsCorrect = false},
            new Answer {AnswerId = 20,  QuestionId = 5, AnswerText = "Answer 4", IsCorrect = true},

            new Answer {AnswerId = 21,  QuestionId = 6, AnswerText = "Answer 1", IsCorrect = false},
            new Answer {AnswerId = 22,  QuestionId = 6, AnswerText = "Answer 2", IsCorrect = true},
            new Answer {AnswerId = 23,  QuestionId = 6, AnswerText = "Answer 3", IsCorrect = false},
            new Answer {AnswerId = 24,  QuestionId = 6, AnswerText = "Answer 4", IsCorrect = false},

            new Answer {AnswerId = 25,  QuestionId = 7, AnswerText = "Answer 1", IsCorrect = false},
            new Answer {AnswerId = 26,  QuestionId = 7, AnswerText = "Answer 2", IsCorrect = true},
            new Answer {AnswerId = 27,  QuestionId = 7, AnswerText = "Answer 3", IsCorrect = false},
            new Answer {AnswerId = 28,  QuestionId = 7, AnswerText = "Answer 4", IsCorrect = false},

            new Answer {AnswerId = 29,  QuestionId = 8, AnswerText = "Answer 1", IsCorrect = false},
            new Answer {AnswerId = 30,  QuestionId = 8, AnswerText = "Answer 2", IsCorrect = false},
